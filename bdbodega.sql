CREATE DATABASE  IF NOT EXISTS `bdbodega` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `bdbodega`;
...
CREATE TABLE `tbl_bodega` (
  ...
  `nombre_bodega` varchar(25) DEFAULT NULL,
...
CREATE TABLE `tbl_productos` (
  ...
  `codigo_bodega` varchar(25) DEFAULT NULL,
...
--
-- Dumping events for database 'bdbodega'
--

--
-- Dumping routines for database 'bdbodega'tbl_bodega
--
